...
*Generated by pmkit • 5 tool calls • 4 sources (Jira, Confluence, Slack, Amplitude)*`,
  ...
  prototype_generation: {
    ...
    content: `# UI Prototype: Search Filters

**Generated from**: PRD: Search Filters (ACME-100)
...
The prototype demonstrates the core search filters user experience as defined in the PRD.
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="sm">
              ...
              {customDate ? customDate.toLocaleDateString() : 'Pick date'}
            </Button>
          </PopoverTrigger>
...
|------------|-----------|--------|
| Filter by date range | SearchFilters | ✅ Implemented |
| Filter by content type | SearchFilters | ✅ Implemented |
| Combine multiple filters | SearchFilters | ✅ Implemented |
| Clear all filters | SearchFilters | ✅ Implemented |
| See filter state in results | SearchResults | ✅ Implemented |
| Custom date range | Calendar Popover | ✅ Implemented |
...
- Uses shadcn/ui Select, Button, Popover, Calendar components
- Follows existing color scheme (muted backgrounds, foreground text)
- Consistent spacing with existing search UI
...
---
*Generated by pmkit • 4 tool calls • 2 sources (Confluence, Jira)*`,
  },
  release_notes: {
