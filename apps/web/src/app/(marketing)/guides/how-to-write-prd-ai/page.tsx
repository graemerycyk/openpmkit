...
export const metadata: Metadata = {
  title: 'How to Write a PRD with AI | pmkit Guide',
  description:
...
const steps = [
  ...
  },
  {
    ...
    pmkitHelp: 'pmkit generates user stories based on customer language and use cases found in your data. Stories are ranked by how many customers mentioned similar needs.',
  },
  {
    number: 4,
  ...
  },
  {
    ...
    pmkitHelp: 'pmkit PRDs include an evidence appendix with all citations. Stakeholders can click through to original sources to verify claims.',
  },
];
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-cobalt-100">
              Generate a PRD with cited evidence in the pmkit demo.
            </p>
