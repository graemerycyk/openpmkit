...
export const metadata: Metadata = {
  title: 'How to Prioritize Features with AI | pmkit Guide',
  description:
...
const steps = [
  ...
  },
  {
    ...
    pmkitHelp: 'pmkit provides customer counts and source breakdowns for each theme—X customers mentioned this in Y tickets and Z calls.',
  },
  {
    number: 4,
  ...
  },
  {
    ...
    pmkitHelp: 'pmkit provides the customer evidence that informs your scoring. The final prioritization decision is yours.',
  },
];
