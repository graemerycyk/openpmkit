...
export const metadata: Metadata = {
  title: 'How to Automate Release Notes | openpmkit Guide',
  description:
...
const steps = [
  {
    number: 1,
    title: 'Connect Jira',
    description: 'Link openpmkit to your Jira instance via OAuth. openpmkit needs read access to issues and projects.',
    tips: [
    ...
    pmkitHelp: 'One-time OAuth setup. openpmkit requests only the permissions needed to read issues and generate notes.',
  },
  {
    number: 2,
    title: 'Configure Your Project',
    description: 'Tell openpmkit which Jira project(s) to monitor and how to categorize issues.',
    tips: [
  ...
  },
  {
    ...
    description: 'Run the release notes workflow. openpmkit pulls issues and generates customer-friendly notes.',
    tips: [
