...
export const metadata: Metadata = {
  title: 'Jira Integration | openpmkit - AI-Powered Jira Automation',
  description:
    'Connect openpmkit with Jira for AI-powered sprint reviews, PRD-to-epic conversion, and automated release notes. Draft-only governance ensures human approval.',
  keywords: [
    'Jira AI integration',
    'Jira automation',
    'AI sprint review',
  ...
  openGraph: {
    title: 'openpmkit + Jira Integration',
...
const useCases = [
  ...
  },
  {
    ...
    description: 'At sprint end, openpmkit summarizes completed work, blockers, and carryover items automatically.',
  },
  {
...
const faqs = [
  {
    question: 'How does openpmkit connect to Jira?',
    answer: 'openpmkit uses Atlassian OAuth 2.0 for secure authentication. You authorize openpmkit to access your Jira instance, and credentials are encrypted at rest. openpmkit can read issues and propose writes, but all writes require your approval.',
  },
  {
    question: 'What Jira permissions does openpmkit need?',
  ...
  {
    question: 'Can openpmkit create Jira tickets automatically?',
  ...
  },
  {
    ...
    answer: 'Currently openpmkit supports Jira Cloud. Jira Server/Data Center support is planned for enterprise customers.',
  },
  {
    question: 'How does sprint review generation work?',
    answer: 'At the end of a sprint, openpmkit pulls all issues from the sprint, analyzes status changes and comments, then generates a summary document with completed work, blockers, and carryover items.',
  },
  {
    question: 'Can I customize the Jira field mappings?',
    answer: 'Yes, enterprise customers can customize how openpmkit fields map to their Jira configuration, including custom fields and workflows.',
  },
];
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              openpmkit + <span className="text-cobalt-600">Jira</span>
            </h1>
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              openpmkit reads from Jira and proposes writes. Every action requires your approval.
            </p>
          </div>
      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              How product teams use openpmkit with Jira.
            </p>
          </div>
