...
export const metadata: Metadata = {
  title: 'Gong Integration | openpmkit - AI Insights from Sales Calls',
  description:
    'Connect openpmkit with Gong for AI-powered VoC analysis, call transcript insights, and cited customer evidence in PRDs.',
  keywords: [
    'Gong AI integration',
    'Gong call insights',
  ...
  openGraph: {
    title: 'openpmkit + Gong Integration',
...
const faqs = [
  {
    question: 'How does openpmkit connect to Gong?',
    answer: 'openpmkit uses Gong\'s API with OAuth for secure authentication. You authorize openpmkit to access call transcripts, and credentials are encrypted at rest.',
  },
  {
    question: 'What Gong data can openpmkit access?',
  ...
  },
  {
    ...
    answer: 'Yes. When generating PRDs or VoC reports, openpmkit searches your Gong calls for relevant customer statements about the topic you\'re researching.',
  },
  {
  ...
  {
    question: 'How recent are the calls openpmkit can access?',
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              openpmkit + <span className="text-cobalt-600">Gong</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground">
              Turn sales calls into product insights. openpmkit extracts customer evidence from
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              openpmkit reads Gong call transcripts and extracts actionable customer insights.
            </p>
          </div>
      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              How product teams use openpmkit with Gong.
            </p>
          </div>
