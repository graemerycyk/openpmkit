...
export const metadata: Metadata = {
  title: 'Zendesk Integration | pmkit - AI Support Ticket Analysis',
  description:
    'Connect pmkit with Zendesk for AI-powered VoC analysis, ticket clustering, and customer evidence for PRDs.',
  keywords: [
  ...
  openGraph: {
    title: 'pmkit + Zendesk Integration',
...
const faqs = [
  {
    question: 'How does pmkit connect to Zendesk?',
    answer: 'pmkit uses Zendesk OAuth for secure authentication. You authorize pmkit to access tickets, and credentials are encrypted at rest. pmkit reads ticket data only—no writes to Zendesk.',
  },
  {
    question: 'What Zendesk data can pmkit access?',
  ...
  },
  {
    ...
    answer: 'pmkit uses AI to analyze ticket content and group similar issues into themes. Each theme includes sample tickets and a count of affected customers.',
  },
  {
    question: 'Can pmkit update Zendesk tickets?',
    answer: 'No, pmkit is read-only for Zendesk. It analyzes tickets for insights but never modifies them. This simplifies permissions and ensures support workflows aren\'t affected.',
  },
  {
    question: 'How far back can pmkit analyze?',
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              pmkit + <span className="text-cobalt-600">Zendesk</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground">
              Transform support tickets into product insights. pmkit clusters customer issues,
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              pmkit reads Zendesk tickets and transforms them into actionable product insights.
            </p>
          </div>
      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              How product teams use pmkit with Zendesk.
            </p>
          </div>
