...
export const metadata: Metadata = {
  title: 'Slack Integration | openpmkit - AI Daily Briefs from Slack',
  description:
    'Connect openpmkit with Slack for AI-powered daily briefs, channel synthesis, and cited insights. Never miss important updates again.',
  keywords: [
  ...
  openGraph: {
    title: 'openpmkit + Slack Integration',
...
const useCases = [
  ...
  },
  {
    ...
    description: 'When writing PRDs, openpmkit pulls relevant Slack conversations as evidence.',
  },
];

const faqs = [
  {
    question: 'How does openpmkit connect to Slack?',
    answer: 'openpmkit uses Slack OAuth for secure authentication. You authorize openpmkit to access specific channels, and your credentials are encrypted at rest. openpmkit reads messages but never posts without your approval.',
  },
  {
    question: 'What Slack permissions does openpmkit need?',
  ...
  {
    question: 'Can openpmkit post to Slack?',
    answer: 'Currently openpmkit is read-only for Slack. It synthesizes messages into daily briefs and PRDs. Slack posting for brief delivery is on the roadmap.',
  },
  {
    question: 'How far back does openpmkit read?',
    answer: 'Daily briefs pull the last 24-36 hours (configurable). For PRD evidence, openpmkit can search further back to find relevant customer conversations.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. OAuth tokens are encrypted with AES-256. openpmkit processes messages in memory and only stores citations, not full message content. We\'re SOC 2 Type II compliant (in progress).',
  },
];
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              openpmkit + <span className="text-cobalt-600">Slack</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground">
              Never miss important conversations again. openpmkit synthesizes your Slack channels
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              openpmkit reads your Slack channels and synthesizes them into actionable insights.
            </p>
          </div>
      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              How product teams use openpmkit with Slack.
            </p>
          </div>
