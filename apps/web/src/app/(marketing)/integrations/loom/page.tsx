...
export const metadata: Metadata = {
  title: 'Loom Integration | openpmkit - AI-Powered Video Transcript Analysis',
  description:
    'Connect openpmkit with Loom to extract insights from video transcripts, cite stakeholder walkthroughs in PRDs, and surface key decisions from async updates.',
  keywords: [
    'Loom AI integration',
  ...
  openGraph: {
    title: 'openpmkit + Loom Integration',
...
const features = [
  ...
  },
  {
    ...
    description: 'All insights are read-only. openpmkit cites Loom content but never modifies your recordings.',
  },
];
...
const useCases = [
  {
    ...
    description: 'When stakeholders share Loom walkthroughs, openpmkit extracts requirements, concerns, and decisions for your PRDs.',
  },
  {
...
const faqs = [
  ...
  {
    question: 'Does openpmkit watch my videos?',
    answer: 'pmkit processes transcripts, not video content. Loom automatically generates transcripts, and openpmkit analyzes that text to extract insights, decisions, and key points.',
  },
  {
    question: 'Can openpmkit access private Looms?',
  ...
  },
  {
    ...
    answer: 'When generating PRDs, briefs, or meeting prep packs, openpmkit can cite relevant Loom transcripts with timestamps. This provides traceability back to the original video.',
  },
  {
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              openpmkit + <span className="text-cobalt-600">Loom</span>
            </h1>
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              openpmkit reads Loom transcripts and extracts actionable insights for your PM workflows.
            </p>
          </div>
      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              How product teams use openpmkit with Loom.
            </p>
          </div>
