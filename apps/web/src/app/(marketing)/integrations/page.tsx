...
export const metadata: Metadata = {
  ...
  description:
    'Connect openpmkit with your existing tools: Jira, Slack, Gong, Confluence, Zendesk, and more. AI-powered workflows that work with your stack.',
  keywords: [
    'pmkit integrations',
    'Jira AI integration',
  ...
  openGraph: {
    title: 'openpmkit Integrations',
    description: 'Connect openpmkit with Jira, Slack, Gong, Confluence, Zendesk, and more.',
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              Beyond your connected tools, openpmkit can search the web for competitive intelligence,
      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              openpmkit uses secure OAuth connections to integrate with your tools.
            </p>
          </div>
              ...
              {[
                {
                  step: '01',
                  title: 'Connect',
                  description: 'OAuth flow connects openpmkit to your tools. Your credentials are encrypted at rest.',
                },
                {
                  step: '02',
                  title: 'Read',
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-cobalt-100">
              Try the demo to see how openpmkit synthesizes data from multiple tools into actionable artifacts.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="bg-white text-cobalt-600 border-white hover:bg-cobalt-50" asChild>
                <Link href="https://github.com/openpmkit/openpmkit">Star on GitHub</Link>
              </Button>
            </div>
          </div>
        </div>
