...
export const metadata: Metadata = {
  title: 'Confluence Integration | pmkit - AI Document Management',
  description:
    'Connect pmkit with Confluence for AI-powered PRD publishing, context retrieval, and documentation automation.',
  keywords: [
  ...
  openGraph: {
    title: 'pmkit + Confluence Integration',
...
const faqs = [
  {
    question: 'How does pmkit connect to Confluence?',
    answer: 'pmkit uses Atlassian OAuth 2.0 for secure authentication. You authorize pmkit to access your Confluence instance, and credentials are encrypted at rest.',
  },
  {
    question: 'What Confluence permissions does pmkit need?',
  ...
  {
    question: 'Can pmkit publish to Confluence automatically?',
  ...
  },
  {
    ...
    answer: 'Currently pmkit supports Confluence Cloud. Confluence Server/Data Center support is planned for enterprise customers.',
  },
  {
    question: 'Can pmkit read existing Confluence pages?',
    answer: 'Yes. pmkit can read your existing documentation to provide context when drafting PRDs. This ensures consistency with your existing specs and terminology.',
  },
  {
    question: 'How does template compliance work?',
    answer: 'You can configure pmkit to use your Confluence templates. Generated pages follow your standard structure and include required sections.',
  },
];
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              pmkit + <span className="text-cobalt-600">Confluence</span>
            </h1>
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              pmkit reads from Confluence and proposes new pages. Every publish requires your approval.
            </p>
          </div>
      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              How product teams use pmkit with Confluence.
            </p>
          </div>
