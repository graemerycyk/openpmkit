        ...
        <div className="container">
          <div className="mx-auto max-w-3xl">
            <div className="flex items-center gap-2 text-cobalt-600">
              ...
              <span className="text-sm font-semibold uppercase tracking-wide">
                The openpmkit Solution
              </span>
            </div>
            <h2 className="mt-2 font-heading text-2xl font-bold">
              How openpmkit handles {resource.primaryKeyword}
            </h2>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    openpmkit never writes directly to external systems. All outputs are proposals that
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="bg-white text-cobalt-600 border-white hover:bg-cobalt-50" asChild>
                <Link href="https://github.com/openpmkit/openpmkit">View Pricing</Link>
              </Button>
            </div>
          </div>
        </div>
