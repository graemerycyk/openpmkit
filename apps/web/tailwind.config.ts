      ...
      typography: {
        DEFAULT: {
          css: {
            ...
            p: { fontFamily: 'var(--font-geist-sans), system-ui, sans-serif' },
            li: { fontFamily: 'var(--font-geist-sans), system-ui, sans-serif' },
            blockquote: { fontFamily: 'var(--font-geist-sans), system-ui, sans-serif' },
            td: { fontFamily: 'var(--font-geist-sans), system-ui, sans-serif' },
            th: { fontFamily: 'var(--font-geist-sans), system-ui, sans-serif' },
          },
        },
      },
      keyframes: {
