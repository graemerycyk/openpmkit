...
export const resources: ResourcePage[] = [
  // Agents Category
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          'openpmkit uses  a draft-only approach: agents propose changes (new epics, PRD pages, Slack messages) but never write directly. You review, edit, and approve before anything is published.',
      },
      {
  ...
  },
  {
    ...
    faqItems: [
      ...
      {
        question: 'How does openpmkit ensure AI output quality?',
        answer:
  ...
  },
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          'openpmkit connects to Jira, Confluence, Slack, Gong, Zendesk, community platforms, and analytics tools via secure OAuth connectors.',
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "openpmkit gathers customer evidence (VoC themes, feature requests, call transcripts), existing documentation, and analytics signals. It then drafts a PRD following your template, with sources cited for every claim.",
      },
      {
  ...
  },
  {
    ...
    faqItems: [
      {
        question: 'What competitor changes does openpmkit track?',
        answer:
  ...
  },
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          'By default, openpmkit analyzes the last 90 days of interactions. You can adjust this window based on account activity and relationship length.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes. openpmkit can pull meeting context from Google Calendar or Outlook, automatically identifying the account and attendees.',
      },
    ],
  },
  ...
  // Integrations Category
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          'No. openpmkit creates a draft proposal that you review and approve. Only after approval is the epic created in Jira.',
      },
      {
  ...
  },
  {
    ...
    faqItems: [
      {
        question: 'What insights does openpmkit extract from Gong?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Currently openpmkit supports Gong natively. Chorus and other tools are on the roadmap. Contact us for specific integration requests.',
      },
    ],
  },
  {
    ...
    faqItems: [
      {
        question: 'Which community platforms does openpmkit support?',
        answer:
          'openpmkit connects to Discourse, GitHub Discussions, Reddit, and custom community platforms via secure OAuth connectors.',
      },
      {
        question: 'How are feature requests prioritized?',
        answer:
          "openpmkit surfaces requests by vote count, comment activity, and customer segment. You can filter by status (open, planned, completed) and category.",
      },
      {
        question: 'Can I link community requests to Jira epics?',
        answer:
          'Yes. When drafting Jira epics, openpmkit can include links to related community requests and their vote counts.',
      },
      {
        question: 'How do I close the loop with the community?',
        answer:
          'openpmkit can draft community update posts when features ship, linking back to the original requests that influenced the decision.',
      },
    ],
  },
  {
    ...
    faqItems: [
      {
        ...
        answer:
          'openpmkit automates daily briefs, sprint review packs, release notes, stakeholder updates, VoC reports, and competitor research reports.',
      },
      {
        question: 'How do I set up recurring jobs?',
        answer:
          'Configure job schedules (daily, weekly, sprint-aligned) in the openpmkit console. Jobs run automatically and deliver artifacts to your preferred channels.',
      },
      {
  ...
  // Governance Category
  {
    ...
    faqItems: [
      {
        question: 'What governance features does openpmkit include?',
        answer:
  ...
  },
  {
    ...
    description:
      'Connect openpmkit to your enterprise tools via secure OAuth integrations for standardized, auditable access.',
    ...
    workedExample: {
      ...
      scenario: 'An enterprise customer uses a custom CRM that openpmkit doesn\'t support natively. They need to integrate it for meeting prep.',
      steps: [
    ...
    faqItems: [
      {
        question: 'How do openpmkit connectors work?',
        answer:
  ...
  },
  {
    ...
    faqItems: [
      {
        question: 'What Jira workflows can openpmkit automate?',
        answer:
          'openpmkit can draft epics from Slack conversations, create stories from PRDs, propose sprint scope based on capacity, and generate release notes from completed tickets.',
      },
      {
        question: 'What Confluence workflows are supported?',
        answer:
          'openpmkit can draft PRD pages, update roadmap documents, create meeting notes, and generate VoC reports, all as proposals for your review.',
      },
      {
        question: 'Does openpmkit support Jira Cloud and Data Center?',
        answer:
  ...
  },
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          'Yes. From the same source data, openpmkit can generate customer-facing notes, sales talking points, and technical changelogs with appropriate detail for each audience.',
      },
      {
        question: 'Does it connect features to customer requests?',
        answer:
          'Yes. openpmkit can reference VoC data and PRDs to include statements like "This addresses feedback from 89 customers who requested better search capabilities."',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqItems: [
      {
        question: 'What analytics sources does openpmkit analyze?',
        answer:
          'openpmkit connects to Amplitude, Mixpanel, Algolia, Segment, and custom analytics platforms via secure OAuth connectors.',
      },
      {
  ...
  },
  {
    ...
    faqItems: [
      {
        question: 'How does openpmkit detect dependency drift?',
        answer:
      ...
      },
      {
        ...
        answer:
          'openpmkit can draft Slack messages to dependent teams, propose Jira comments, or escalate to stakeholders, all as proposals for your review.',
      },
      {
  ...
  },
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          'Deck Content pulls from openpmkit artifacts (VoC reports, competitor research, PRDs), Jira (sprint metrics, roadmap), Amplitude (product metrics), and Confluence (existing documentation). The more context you provide, the better the output.',
      },
      {
  ...
  // Jira Integration
  {
    ...
    description:
      'Connect Jira to openpmkit to sync issues, epics, and sprint data for automated PRDs, daily briefs, and sprint reviews.',
    ...
    workedExample: {
      ...
      scenario: 'A PM connects Jira to openpmkit to automate their daily brief generation with real-time sprint data.',
      steps: [
        'Connect Jira via OAuth in openpmkit settings',
    ...
    faqItems: [
      {
        question: 'What Jira data does openpmkit access?',
        answer:
      ...
      {
        question: 'What permissions does openpmkit need?',
        answer:
  ...
  // Confluence Integration
  {
    ...
    description:
      'Connect Confluence to openpmkit to access existing documentation and publish PRDs, meeting notes, and artifacts directly.',
    ...
    workedExample: {
      ...
      steps: [
        'Connect Confluence via OAuth in openpmkit settings',
      ...
      outcome: 'PRDs flow seamlessly from openpmkit to Confluence. Team members access documentation in their familiar workspace. Version history is maintained.',
    },
    keyBenefits: [
    ...
    faqItems: [
      {
        question: 'What Confluence data does openpmkit access?',
        answer:
          'pmkit reads pages, spaces, and page hierarchies. It can propose new pages but requires your approval before publishing.',
      },
      {
        question: 'Can openpmkit update existing Confluence pages?',
        answer:
          'Yes. openpmkit can propose updates to existing pages. You review the changes before they\'re applied.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes. When publishing, you select the target space and parent page. openpmkit respects your Confluence permissions.',
      },
    ],
  },
  ...
  // Slack Integration
  {
    ...
    description:
      'Connect Slack to openpmkit for notifications, job triggers, and extracting product discussions from channels.',
    ...
    workedExample: {
      ...
      steps: [
        'Connect Slack via OAuth in openpmkit settings',
        'Configure which channels to monitor for product discussions',
        'React to a thread with the openpmkit emoji or use /pmkit command',
    ...
    faqItems: [
      {
        question: 'What Slack data does openpmkit access?',
        answer:
      ...
      {
        question: 'Does openpmkit read private channels?',
        answer:
          'Only if you explicitly add openpmkit to the private channel. openpmkit respects Slack\'s permission model.',
      },
    ],
  },
  ...
  // MCP Integration
  {
    ...
    title: 'MCP Integration: Connect openpmkit to Your AI Client',
    description:
      'Use Model Context Protocol (MCP) to connect openpmkit tools to Cursor, Claude Desktop, or other AI clients.',
    ...
    workedExample: {
      title: 'Adding openpmkit to Cursor IDE',
      scenario: 'A developer wants to access openpmkit tools directly from their Cursor IDE.',
      steps: [
        'Copy the openpmkit MCP configuration from Settings → Integrations',
        'Open Cursor settings and navigate to MCP configuration',
        'Paste the openpmkit config into your mcp.json file',
        'Restart Cursor to load the new MCP server',
        'pmkit tools are now available in Cursor\'s AI assistant',
      ],
      outcome: 'Developers can query openpmkit data, run jobs, and access artifacts directly from their IDE without context switching.',
    },
    keyBenefits: [
      'Access openpmkit from your IDE',
    ...
    faqItems: [
      ...
      {
        question: 'What openpmkit tools are available via MCP?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Yes. MCP connections use your openpmkit API key for authentication. All requests are logged in the audit trail.',
      },
    ],
  },
  ...
  // Gong Integration
  {
    ...
    description:
      'Connect Gong to openpmkit to automatically extract pain points, feature requests, and competitive mentions from sales and CS calls.',
    ...
    workedExample: {
      ...
      steps: [
        'Connect Gong via OAuth in openpmkit settings',
    ...
    faqItems: [
      {
        question: 'What Gong data does openpmkit access?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Currently openpmkit supports Gong natively. Chorus integration is on the roadmap.',
      },
    ],
  },
  ...
  // Zendesk Integration
  {
    ...
    description:
      'Connect Zendesk to openpmkit to analyze support tickets for VoC clustering, escalation tracking, and trend analysis.',
    ...
    workedExample: {
      ...
      steps: [
        'Connect Zendesk via OAuth in openpmkit settings',
    ...
    faqItems: [
      {
        question: 'What Zendesk data does openpmkit access?',
        answer:
          'pmkit reads tickets, comments, tags, and custom fields. It respects your Zendesk views and permissions.',
      },
      {
        question: 'Can openpmkit create or update tickets?',
        answer:
          'openpmkit can propose ticket updates (like adding tags) but never writes directly. All changes require your approval.',
      },
      {
  ...
  // Amplitude Integration
  {
    ...
    description:
      'Connect Amplitude to openpmkit to pull product analytics, feature usage data, and user journeys into PRDs and reports.',
    ...
    workedExample: {
      ...
      steps: [
        'Connect Amplitude via OAuth in openpmkit settings',
    ...
    faqItems: [
      {
        question: 'What Amplitude data does openpmkit access?',
        answer:
      ...
      },
      {
        ...
        answer:
          'openpmkit can reference Amplitude metrics and trends. For visual charts, link to Amplitude dashboards.',
      },
      {
        question: 'How do I configure which events to sync?',
        answer:
          'Select specific events, properties, and cohorts in the integration settings. openpmkit only accesses what you configure.',
      },
      {
        question: 'Does openpmkit support other analytics tools?',
        answer:
  ...
  // Discourse Integration
  {
    ...
    description:
      'Connect Discourse to openpmkit to monitor community discussions, feature requests, and user feedback.',
    ...
    workedExample: {
      ...
      steps: [
        'Connect Discourse via API key in openpmkit settings',
    ...
    faqItems: [
      {
        question: 'What Discourse data does openpmkit access?',
        answer:
          'pmkit reads topics, posts, likes, and user activity from configured categories. It respects your Discourse permissions.',
      },
      {
        question: 'Can openpmkit post to Discourse?',
        answer:
          'openpmkit can propose posts (like feature shipped announcements) but requires your approval before posting.',
      },
      {
      ...
      {
        question: 'Does openpmkit support other community platforms?',
        answer:
